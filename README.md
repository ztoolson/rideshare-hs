...
```
createuser rideshare-hs --pwprompt --superuser
# Enter password rideshare-hs when prompted
createdb rideshare-hs
createdb rideshare-hs_test
```
...
```
stack test --flag rideshare-hs:library-only --flag rideshare-hs:dev
```
